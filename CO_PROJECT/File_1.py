    ...
    if not (tmp_flag):
        ...
        for instruction in tmp_words[0:-1]:
            if instruction[-1] == "hlt":
                flag = 0
                print("ERROR_in_hlt: General syntax error.\nError in line:",word_index)  # hlt occurs before last instruction
    return flag
...
def identify_error_type(lst):
    ...
    if lst[0] in ['mov']:
        ...
        print("ERROR:Typos in register name. Error in line:",(empty_lines.index(" ".join(lst))))
        flag = 0
